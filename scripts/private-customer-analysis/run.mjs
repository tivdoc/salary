...
const [privateRoot,documentId,credentialsFile]=process.argv.slice(2);
...
const run=spawnSync(process.execPath,[out,root,documentId,path.resolve(credentialsFile),revision],{stdio:'inherit',env:{...process.env,NODE_PATH:path.join(repository,'node_modules')}});
