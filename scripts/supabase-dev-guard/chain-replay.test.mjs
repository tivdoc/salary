...
describe("V0.10.9 byte-pinned chain replay", () => {
  it("discovers every migration in filename order with LF-normalized hashes", async () => {
    ...
    expect(files.at(-2)?.name).toBe("20260909185038_june2026_collection_source_link.sql");
    expect(files.at(-1)?.name).toBe("20260909212737_direct_resend_provider_receipts.sql");
