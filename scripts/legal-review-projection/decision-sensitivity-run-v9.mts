...
async function main(): Promise<void> {
  ...
  const content = {
    schema_version: "tivdoc-decision-sensitivity-report-v9-v0.14.0",
    ...
    replaces: "tivdoc-decision-sensitivity-report-v8-v0.13.0 (v8 ran fourteen shadow specs with the recorded daily-threshold default unbound and the statute running in its place; v9 runs fifteen — the derived five-day norm bound and executing as the default — and carries the default-transition table)",
    scope_note:
  ...
  writeFileSync(path.join(RECEIPT_ROOT, "decision-sensitivity-report-v9.json"), `${JSON.stringify(report, null, 2)}\n`, "utf8");
