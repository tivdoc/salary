...
async function main(): Promise<void> {
  ...
  const content = {
    schema_version: "tivdoc-decision-sensitivity-report-v6-v0.11.0",
    ...
    replaces: "tivdoc-decision-sensitivity-report-v5-v0.10.18 (v5 ran 7 of 7 without the shadow beside it)",
    scope_note:
  ...
  writeFileSync(path.join(RECEIPT_ROOT, "decision-sensitivity-report-v6.json"), `${JSON.stringify(report, null, 2)}\n`, "utf8");
