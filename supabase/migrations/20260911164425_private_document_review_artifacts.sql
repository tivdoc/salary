...
create function public.case_report_private_review_list(target_case uuid,target_identity uuid) returns jsonb
...
begin
 ...
 from public.analysis_runs ar join private.case_input_heads h on h.case_id=ar.case_id
 ...
 where ar.case_id=target_case and ar.tenant_id='saved-case:'||target_case::text and ar.canonical_case_id=target_case::text and ar.status='completed'
...
create function public.case_report_private_review_artifact(target_case uuid,target_identity uuid,target_report uuid) returns jsonb
language plpgsql stable security definer set search_path='' as $$
...
begin
 ...
 from public.analysis_runs ar where ar.case_id=target_case and ar.tenant_id='saved-case:'||target_case::text
