# Document review product integration

Base: `3a2456242f86e9867cff76109b36c2588839f23a`, branch `codex/tivdoc-release-completion`.
...
- Completion agent: minimal source-bound requests, existing-answer suppression, internal applicability/ownership work, dependency-specific answers.
- Report agent: versioned Hebrew PDF layout and regular product document-review renderer.
