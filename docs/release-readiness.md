...
- Current fresh schema proof: `tivdoc_release_chain_20260908_37a3313`, 115 migrations, 113 raw and two explicitly recorded managed-platform compensations. Shared role provisioning unchanged. This separate database contains no customer fixtures.
...
| Downward price correction | Immutable cumulative request ledger and original-policy arithmetic; preserves paid terms and entitlement | 10 actual worker/peer/web DB checks, 83 local checks across pricing/correction/chain/definer files | Applied only to DEV schema; no provider dispatch/settlement, customer/owner queue UI or canonical correction reader |
