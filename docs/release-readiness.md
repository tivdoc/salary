...
- Verified [isolated Preview](https://salary-1vlhcfu08-tivdoccom-5042s-projects.vercel.app): exact `ee4a8be9f90ba8ae93dbfe4a52ff003099919dcc`, deployment `dpl_CGKBZ9SWrLusgQYEm57mHmza28oA`. CI `34265017223` and `34265013898` pass. Includes payment reference binding and canonical input retention; later inactive vacation research remains source-only.
...
The current combined [99-check receipt](release-evidence/P13-ee4a8be-integrated-preview.json) identifies its exact source. Nine Storage objects and ten owned synthetic cases/identities were removed after the hosted checks; no real customer was used. The exact deployment's 20-minute error query returned zero rows. A passing synthetic report is not a validated salary finding or a real payment.
