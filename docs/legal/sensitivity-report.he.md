...
המסמך נוצר אוטומטית מ־`decision-sensitivity-report-v5.json` (`03fa87dc1b17ae63…`).
...
| תרחישים שנוסו | 90 |
| תרחישים שרצו | 75 |
| תרחישים שסורבו סירוב סגור | 15 |
| עקבות חישוב שנשמרו | 75 |
| עקבות ששוחזרו מהמסד בית־בבית | 75 |
...
סיכום: בתוך בחירת מסמך — 2; אומת בטקסט — 13; נקרא מתמונת העמוד — ממתין לאימות חזותי — 4; מילה שנקראה דרך הלקסיקון — 2.
