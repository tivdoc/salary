...
import {travelProductFactsSchema,travelFareSourceContextSchema,travelCaseRecipeBindingSchema} from './product-facts.ts';
...
export const travelEntitlementInputSchema=z.object({schema_version:z.literal('travel-entitlement-input-v1'),catalog_id:z.literal('il.review.travel.general.2026'),catalog_version:z.literal('1.0.0'),
 calculation_policy:z.literal(TRAVEL_GENERAL_ORDER_FLOOR_POLICY).optional(),
 ...
 product_facts:travelProductFactsSchema.optional(),fare_source_context:travelFareSourceContextSchema.optional(),case_recipe_bindings:z.array(travelCaseRecipeBindingSchema).max(4).optional(),
