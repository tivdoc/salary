...
export function OrderPurchase({publicId,initial=false}:{publicId?:string;initial?:boolean}){
 ...
 {error?<p role="alert">{error} אפשר לנסות שוב לאחר חידוש החיבור.</p>:null}<p>חזרה מסליקה אינה אישור תשלום. ההזמנה מתעדכנת לאחר אימות הספק.</p></section>;
}
