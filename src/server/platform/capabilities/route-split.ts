...
export const ROUTE_SPLIT: readonly RouteAssignment[] = Object.freeze([
  ...
  { entrypoint_id: "CEP-105", route_file: "src/app/api/cases/[token]/requests/route.ts", stable_entry: "/api/cases/[id]/requests", half: "product", reason: "Site S3.4 / D-2: answers one open request; it cannot open one, and the case comes from the session rather than the body.", probes: [{ method: "POST", path: "/api/cases/TV-PROBE001/requests", expected: "400" }], added_on_branch: true },
