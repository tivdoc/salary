...
export function decodeDependencies(value: unknown): PinnedAnalysisDependencies {
  ...
  if (row.code_version !== "case-analysis@0.6.0" && row.code_version !== "case-analysis@0.6.1" && row.code_version !== "case-analysis@0.6.2") throw new PostgresAnalysisError("ANALYSIS_ROW_VERSION_UNSUPPORTED");
  return Object.freeze({
    extraction_snapshot_sha256: sha256(row.extraction_snapshot_sha256),
