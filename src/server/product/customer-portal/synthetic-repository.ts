...
const PROMPTS_HE: Readonly<Record<FactPath, string>> = Object.freeze({
  ...
  "compensation.overtime_pay": "איזה תשלום עבור שעות נוספות מופיע בתלוש לתקופה?",
  "compensation.weekly_rest_pay": "איזה תשלום עבור עבודה במנוחה השבועית מופיע בתלוש לתקופה?",
  ...
  "work.hours_worked_day": "כמה שעות עבדת ביום העבודה שעליו מדובר?",
  "work.rest_day_overtime_hours": "כמה שעות נוספות עבדת ביום המנוחה השבועית?",
  "work.workdays_in_month": "כמה ימי עבודה היו לך בחודש התלוש?",
  ...
  "leave.sick_absence": "באילו תאריכים נעדרת בשל מחלה?",
  "leave.sick_pay": "איזה תשלום דמי מחלה מופיע בתלוש לתקופה?",
  "leave.vacation_days_paid": "כמה ימי חופשה שולמו לך בתקופה?",
