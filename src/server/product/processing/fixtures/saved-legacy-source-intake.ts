...
export function legacySourceIntakeFixture(storedKind:SourceIntakeDocument['type']='payslip'){
 ...
 const document:SourceIntakeDocument={id:'33333333-3333-4333-8333-333333333333',version_id:'44444444-4444-4444-8444-444444444444',sha256:'c'.repeat(64),type:storedKind,page_count:2};
