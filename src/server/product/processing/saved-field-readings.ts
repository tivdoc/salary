...
function readSavedDocumentReadings(input:SavedReadingInput,periodOnly:boolean){
 ...
 for(const value of answers){
  ...
  if(value.field_target&&typeof value.field_target==='object'&&'schema_version' in value.field_target
   &&['document-evidence-source-transcription-v1','document-evidence-source-transcription-v2','document-source-period-intake-v1','obligation-payment-link-v1','obligation-payment-choice-v1'].includes(String(value.field_target.schema_version)))continue;
