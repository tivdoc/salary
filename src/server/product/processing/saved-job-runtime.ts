...
export function savedJobFailure(error:unknown){
 ...
 const holds:Readonly<Record<string,string>>={SOL_BUDGET_EXHAUSTED:'saved_provider_budget_exhausted',
  ...
  SOL_LIVE_WINDOW_CHANGED_OR_EXPIRED:'saved_provider_budget_expired',
  SOL_LIVE_WINDOW_LEDGER_BASELINE:'saved_provider_budget_invalid',SOL_LIVE_WINDOW_LEDGER_APPEND:'saved_provider_budget_invalid',
  SOL_LIVE_WINDOW_LEDGER_REWRITE:'saved_provider_budget_invalid',SOL_LIVE_WINDOW_LEDGER_ROLLBACK:'saved_provider_budget_invalid',
