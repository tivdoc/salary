...
describe('scoped saved job runtime',()=>{
 ...
 it.each([
  ...
  ['SOL_LIVE_WINDOW_CHANGED_OR_EXPIRED','dead_letter','saved_provider_budget_expired'],
  ['SOL_LIVE_WINDOW_LEDGER_BASELINE','dead_letter','saved_provider_budget_invalid'],
  ['SOL_LIVE_WINDOW_LEDGER_APPEND','dead_letter','saved_provider_budget_invalid'],
  ['SOL_LIVE_WINDOW_LEDGER_REWRITE','dead_letter','saved_provider_budget_invalid'],
  ['SOL_LIVE_WINDOW_LEDGER_ROLLBACK','dead_letter','saved_provider_budget_invalid'],
  ['SOL_LIVE_WINDOW_LEDGER_CHANGED','dead_letter','saved_provider_budget_invalid'],
  ['SOL_LIVE_WINDOW_UNKNOWN_COST_ACKNOWLEDGEMENT','dead_letter','saved_provider_budget_invalid'],
  ['SOL_LIVE_WINDOW_CURRENT_RECEIPT','dead_letter','saved_provider_replay_review'],
