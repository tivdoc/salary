...
it('reads a business clock without rejecting the entire operational snapshot',()=>{
 const result=summarizeMonitor({...empty,clocks_total:1,clocks:[{order_id:'11111111-1111-4111-8111-111111111111',started_at:'2026-09-06T06:00:00Z',track:'business',budget_ms:24*3600000,calendar:SERVICE_CALENDAR_2026,pauses:[]}]},{});
 expect(result.clocks).toMatchObject({unknown:0,complete:true,overdue:0});
});
